...
class UserInfo(RbacUserInfo):
    ...
    depart = models.ForeignKey(verbose_name='部门', to="Department", on_delete=models.PROTECT)
...
class ClassList(models.Model):
    ...
    """
    school = models.ForeignKey(verbose_name='校区', to='School', on_delete=models.PROTECT)
    course = models.ForeignKey(verbose_name='课程名称', to='Course', on_delete=models.PROTECT)
    ...
    class_teacher = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',
                                      limit_choices_to={'depart__title': '教质部'}, on_delete=models.PROTECT)
...
class Customer(models.Model):
    ...
    referral_from = models.ForeignKey(
        ...
        related_name="internal_referral", on_delete=models.PROTECT
    )

    course = models.ManyToManyField(verbose_name="咨询课程", to="Course")
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultant',
                                   null=True, blank=True,
                                   limit_choices_to={'depart__title': '销售部'}, on_delete=models.PROTECT)
    education_choices = (
        (1, '重点大学'),
        (2, '普通本科'),
        (3, '独立院校'),
...
class ConsultRecord(models.Model):
    ...
    客户跟进记录
    """
    customer = models.ForeignKey(verbose_name="所咨询客户", to='Customer', on_delete=models.PROTECT)
    consultant = models.ForeignKey(verbose_name="跟踪人", to='UserInfo', on_delete=models.PROTECT)
...
class PaymentRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', help_text="谁签的单就选谁", on_delete=models.PROTECT)
    pay_type_choices = [
        (1, "报名费"),
        (2, "学费"),
        (3, "退学"),
...
class ScoreRecord(models.Model):
    ...
    积分记录
    """
    student = models.ForeignKey(verbose_name='学生', to='Student', on_delete=models.PROTECT)
